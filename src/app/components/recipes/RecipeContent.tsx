...
export default function RecipeContent({ recipe }: { recipe: Recipe }) {
    return (
        <motion.div initial={{ x: '-100%', opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 0.5, ease: 'easeInOut' }}>
            ...
            <div className="w-full lg:w-1/3 my-5 mx-auto border-black border-[1px] text-lg rounded-md p-4 flex justify-evenly">
            ...
            <div className="w-full mx-auto lg:max-w-[67%] font-medium text-lg text-center text-balance">{recipe.description}</div>
            <div className="w-full py-10 flex flex-col space-y-5 lg:space-y-0 lg:flex-row ">
